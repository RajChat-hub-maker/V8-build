...
class V8_EXPORT_PRIVATE TorqueGeneratedExportedMacrosAssembler {
 public:
  ...
  // https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/fixed-array.tq?l=72&c=19
  ...
  TNode<UintPtrT> LoadWasmInternalFunctionSignatureHash(TNode<WasmInternalFunction> p_o);
  // https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=96&c=26
  void StoreWasmInternalFunctionSignatureHash(TNode<WasmInternalFunction> p_o, TNode<UintPtrT> p_v);
